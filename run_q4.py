...
# for img in os.listdir('../hw3/images'):
#     im1 = skimage.img_as_float(skimage.io.imread(os.path.join('../hw3/images',img)))
...
#     params = pickle.load(open('../hw3/python/q3_weights.pickle','rb'))
